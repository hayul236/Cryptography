...
if __name__ == "__main__":
    ...
    encrypted_message = rsa.encrypt_message(msg, pubkey.e, pubkey.n)
    decrypted_message = rsa.decrypt_message(encrypted_message, privkey.d, privkey.n)
    print(
    ...
    signature = rsa.encrypt_message(msg_hash, privkey.d, privkey.n)
    signature_to_verify = rsa.decrypt_message(signature, pubkey.e, pubkey.n)
    print(
